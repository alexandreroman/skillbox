...
7. Apply the `java-best-practices` skill to the
   generated project. Skip step 1 (scope selection)
   and apply **all domains** automatically.

8. Apply the `spring-boot-best-practices` skill to
   the generated project. Skip step 1 (scope
   selection) and apply **all domains**
   automatically.
